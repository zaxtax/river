...
CodeMirror.defineMode("bruno", function(conf, parserConf) {
    ...
    var commonBuiltins = ['abs', 'all', 'any', 'bin', 'bool', 'bytearray', 'callable', 'chr',
                          ...
                          'infer', 'viz', 'observe', 'mh', 'normal', 'bernoulli',
...
CodeMirror.defineMIME("text/x-bruno", "bruno");
